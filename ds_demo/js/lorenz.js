...
Lorenz.generate = function() {
    return [
        50*randn_bm(),50*randn_bm(),50*randn_bm()
    ];
 ...
 * @returns {undefined}
 */
Lorenz.lorenz = function(s, dt, σ, β, ρ, simType,t) {
    ...
    /*Chen-Lee attractor */    
        ...
        b = -10
        d = -0.38
        function dx(x, y, z) { return a*x - y*z ; }
        function dy(x, y, z) { return b*y + x*z; }
        function dz(x, y, z) { return d*z + x*y/3; }
    }
    ...
    /*Rossler attractor */    
        ...
        function dy(x, y, z) { return x + a*y; }
        function dz(x, y, z) { return b + z*(x-c); }
    }

    /*Van der Pol */    
    else if (simType == 3) {
        mu = 1
        function dx(x, y, z) { return mu*(x - (1/3)*x**3 - y) ; }
        function dy(x, y, z) { return x/mu; }
        function dz(x, y, z) { return -10*z; }
    }    

    /*Contracting Recurrent Neural Network, Input-Driven */    
    else if (simType == 4) {
        a = 0.32258065
        b = 100        
        function dx(x, y, z) { return -x + Math.tanh(a* (x - y - z) ) + b*Math.cos(t) ; }
        function dy(x, y, z) { return -y + Math.tanh(a* (x - y - z)) + b*Math.sin(t/2 + t/Math.PI) ; }
        function dz(x, y, z) { return -z + Math.tanh(a* (x + y + z)) + b*Math.cos(t); }
    }

    /*Contracting Recurrent Neural Network, Not Input-Driven */    
    else if (simType == 5) {
        a = 0.32258065         
        function dx(x, y, z) { return -x + Math.tanh(a* (x - y -z)); }
        function dy(x, y, z) { return -y + Math.tanh(a* (x - y -z)); }
        function dz(x, y, z) { return -z + Math.tanh(a* (x + y +z)); }
    }   
    ...
    /*Line Attractor */    
        ...
        m = 3
        b = -18        
        function dx(x, y, z) { return 0 ; }
        function dy(x, y, z) { return -(y - (m*x + b)) ; }
        function dz(x, y, z) { return -z; }
    }  
    
    /*Conservative Double Well Potential*/    
    else if (simType == 7) {
        function dx(x, y, z) { return .9*y ; }
       function dy(x, y, z) { return  .9*(x - x**3) ; }
       function dz(x, y, z) { return -10*z ; }
   }         
    
    /*Multiple Point Attractor*/    
    else if (simType == 8) {
        function dx(x, y, z) { return -50*Math.sin(.1*x) ; }
       function dy(x, y, z) { return  -50*Math.sin(.1*y) ; }
       function dz(x, y, z) { return -50*Math.sin(.1*z) ; }
   }         
...
Lorenz.prototype.step = function() {
    ...
    if (!this.params.paused) {
        ...
        var simType = this.params.simType;
        ...
        for (var s = 0; s < this.params.steps_per_frame; s++) {
            ...
            for (var i = 0; i < this.solutions.length; i++)  {
                Lorenz.lorenz(this.solutions[i], dt, σ, β, ρ, simType,t);
